		 ...
		 int currentcashofplayer = AMOUNT_OF_STAKE;
		    ...
		    for (int i = 1; i <= 30; i++) {
			 ...
			 switch(play) {
				 ...
				 if(currentcashofplayer == 150) {
					 System.out.println("Day"+i+" is Player's Luckiest day "+currentcashofplayer+" $");
				 }
				 else if (currentcashofplayer == 50) {
					 System.out.println("Day"+i+" is Player's Unluckiest day "+currentcashofplayer+" $");
				 }
